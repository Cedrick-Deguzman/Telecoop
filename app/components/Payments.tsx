...
const mockPayments: Payment[] = [
  { id: 1, clientName: 'John Smith', amount: 79.99, status: 'paid', date: '2024-06-01', method: 'Credit Card', invoiceId: 'INV-001234', plan: 'Standard 100Mbps' },
  { id: 2, clientName: 'Sarah Johnson', amount: 49.99, status: 'paid', date: '2024-06-05', method: 'Bank Transfer', invoiceId: 'INV-001235', plan: 'Basic 50Mbps' },
  { id: 3, clientName: 'Mike Davis', amount: 129.99, status: 'paid', date: '2024-06-03', method: 'Credit Card', invoiceId: 'INV-001236', plan: 'Premium 500Mbps' },
  { id: 4, clientName: 'Emily Brown', amount: 79.99, status: 'paid', date: '2024-06-02', method: 'PayPal', invoiceId: 'INV-001237', plan: 'Standard 100Mbps' },
  { id: 5, clientName: 'David Wilson', amount: 199.99, status: 'paid', date: '2024-06-01', method: 'Credit Card', invoiceId: 'INV-001238', plan: 'Ultra 1Gbps' },
  { id: 6, clientName: 'Lisa Anderson', amount: 79.99, status: 'failed', date: '2024-06-01', method: 'Credit Card', invoiceId: 'INV-001239', plan: 'Standard 100Mbps' },
  { id: 7, clientName: 'James Taylor', amount: 49.99, status: 'paid', date: '2024-06-10', method: 'Bank Transfer', invoiceId: 'INV-001240', plan: 'Basic 50Mbps' },
  { id: 8, clientName: 'Jennifer Martinez', amount: 129.99, status: 'pending', date: '2024-06-15', method: 'Credit Card', invoiceId: 'INV-001241', plan: 'Premium 500Mbps' },
  { id: 9, clientName: 'Robert Garcia', amount: 79.99, status: 'paid', date: '2024-06-08', method: 'PayPal', invoiceId: 'INV-001242', plan: 'Standard 100Mbps' },
  { id: 10, clientName: 'Maria Rodriguez', amount: 199.99, status: 'pending', date: '2024-06-12', method: 'Bank Transfer', invoiceId: 'INV-001243', plan: 'Ultra 1Gbps' },
];
