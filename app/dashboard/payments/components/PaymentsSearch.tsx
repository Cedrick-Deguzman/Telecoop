...
interface PaymentsSearchProps {
  ...
  setStatusFilter: (val: 'all' | 'paid' | 'pending'| 'overdue') => void;
}

export function PaymentsSearch({ searchTerm, setSearchTerm, statusFilter, setStatusFilter }: PaymentsSearchProps) {
  return (
